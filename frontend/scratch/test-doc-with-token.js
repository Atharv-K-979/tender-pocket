...
async function run() {
  ...
  try {
    ...
    console.log(`2. Fetching tender details with Authorization header for tender ${tenderId}...`);
    const docRes = await axios.post(
      `https://t247_api.tender247.com/apigateway/T247Tender/api/tender/tender-detail/${tenderId}`,
      { guest_user_id: 0, security_code: "78af32d5-6c65-4c49-9140-a9a835b53b2a", ip: "" },
      { headers }
    );
    console.log("Tender Detail Response:");
