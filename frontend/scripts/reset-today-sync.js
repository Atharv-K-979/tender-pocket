...
const db = new Database('tenders.db');
...
async function reset() {
  ...
  try {
    ...
    try {
      await client.messageFlagsRemove({ uid: [74154, 74280] }, ['\\Seen']);
      console.log("Successfully marked UIDs 74154 and 74280 as Unread in IMAP.");
    } finally {
      lock.release();
    }
  } finally {
